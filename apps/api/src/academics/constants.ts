...
export const CODES = {
  ...
  transfer: {
    ...
    alreadyEnrolledThisYear: 'active_enrollment_this_year',
...
export const MESSAGES = {
  ...
  notAGuardian:
    'Esta pessoa não tem o papel de responsável nesta rede. Convide-a como responsável antes de vinculá-la a um aluno.',
  ...
  transfer: {
    ...
    alreadyEnrolledThisYear:
      'Este aluno ganhou outra matrícula ativa neste ano letivo enquanto a transferência era feita.',
